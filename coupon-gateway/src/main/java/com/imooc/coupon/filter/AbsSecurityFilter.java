...
/**
 * Abstract permission filter, can have multiple implementations.  
 */
@Slf4j
public abstract class AbsSecurityFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        ...
        // If the previous filter fails, the subsequent filter is not called.
    ...
    public Object run() throws ZuulException {
        ...
        if (result == null) {
            ...
            // No routing for the current request
